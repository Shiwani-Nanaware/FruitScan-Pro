...
def detect(image):
    ...
    test_dataset = tensorflow.keras.utils.image_dataset_from_directory(
      "C:\\Users\\mohit\\OneDrive\\Desktop\\Fruit Disease Detection\\Fruit Disease Detection\\fruit_disease_dataset\\data\\test",
        labels = "inferred",
    ...
    # Single Prediction
    print(f"Fruit Disease is: {test_dataset.class_names[result_index[0][0]]}")
    print(f"Fruit Disease is: {td[result_index[0][0]]}")
